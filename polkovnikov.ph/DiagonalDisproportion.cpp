...
struct DiagonalDisproportion {
	int getDisproportion(vector <string> matrix) {
		...
		ei(a, matrix) {
			stringstream ss;
			ss << matrix[ai][ai] << ' ' << matrix[ai][q - ai];
			int x, y;
			ss >> x >> y;
			s += x;
			s -= y;
...
int main() {
	...
	// ----- test 3 -----
	disabled = false;
	p0 = {"7748297018","8395414567","7006199788","5446757413","2972498628","0508396790","9986085827","2386063041","5687189519","7729785238"};
	p1 = -24;
