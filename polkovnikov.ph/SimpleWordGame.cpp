...
struct SimpleWordGame {
	int points(vector <string> player, vector <string> dic) {
		set<string> s, t;
		ei(a, dic) s.insert(a);
		ei(a, player) if (s.find(a) != s.end()) t.insert(a);
		int c = 0;
		ei(a, t) c += sz(a) * sz(a);
		return c;
	}
...
int main() {
	...
	// ----- test 0 -----
	disabled = false;
	p0 = {"apple","orange","strawberry"};
	p1 = {"strawberry","orange","grapefruit","watermelon"};
	p2 = 136;
	...
	// ----- test 3 -----
	disabled = false;
	p0 = {"lidi","o","lidi","gnbewjzb","kten","ebnelff","gptsvqx","rkauxq","rkauxq","kfkcdn"};
	p1 = {"nava","wk","kfkcdn","lidi","gptsvqx","ebnelff","hgsppdezet","ulf","rkauxq","wcicx"};
	p2 = 186;
