...
struct CustomerStatistics {
	vector <string> reportDuplicates(vector <string> cn) {
		map<string, int> x;
		ei(a, cn) ++x[a];
		vector<pair<string, int>> w;
		ei(a, x) if (a.second > 1) w.push_back(a);
		sr(w);
		vector<string> r;
		ei(a, w) {
			stringstream ss;
...
int main() {
	...
	// ----- test 0 -----
	disabled = false;
	p0 = {"JOHN","BOB","JOHN","BILL","STANLEY","JOHN"};
	p1 = {"JOHN 3"};
	...
	// ----- test 1 -----
	disabled = false;
	p0 = {"YETTI","YETTI","YETTI","BIGFOOT","BIGFOOT"};
	p1 = {"BIGFOOT 2","YETTI 3"};
	...
	// ----- test 2 -----
	disabled = false;
	p0 = {"ANDREW","BILL","CINDY","DOH","ERGH","FOO","GOO","HMPH"};
	p1 = {};
