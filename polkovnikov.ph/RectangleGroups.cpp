...
struct RectangleGroups {
	string maximalIndexed(vector <string> rectangles) {
		...
		ei(a, x) y.eb(-a.second, a.first);
		sr(y);
		stringstream ss;
		ss << y[0].second << ' ' << -y[0].first;
		string s;
		getline(ss, s);
		return s;
	}
...
int main() {
	...
	// ----- test 2 -----
	disabled = false;
	p0 = {"D 1 6","F 2 3","G 1 1","G 5 1","C 3 2"};
	p1 = "C 6";
	...
	// ----- test 3 -----
	disabled = false;
	p0 = {"S 2 54","Y 34 65","F 234 23","D 84 127","R 603 46","S 36 192","Y 76 32","T 54 28","S 22 22"};
	p1 = "R 27738";
