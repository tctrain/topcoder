...
int main() {
	...
	// ----- test 0 -----
	disabled = false;
	p0 = {"ball","plane","robot","puzzle"};
	p1 = 3;
	p2 = {"ball puzzle","plane","robot"};
	...
	// ----- test 1 -----
	disabled = false;
	p0 = {"ball","plane","robot","puzzle","bike"};
	p1 = 1;
	p2 = {"ball plane robot puzzle"};
	...
	// ----- test 2 -----
	disabled = false;
	p0 = {"ball","ball","plane","plane"};
	p1 = 2;
	p2 = {"ball plane","ball plane"};
