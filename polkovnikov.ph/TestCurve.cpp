...
struct TestCurve {
	vector <int> determineGrades(vector <int> scores) {
		int mx = 0;
		ei(a, scores) mx = max(mx, a);
		vector<int> r;
		ei(a, scores) r.eb(a * 100 / mx);
		return r;
	}
};
...
int main() {
	...
	// ----- test 2 -----
	disabled = false;
	p0 = {67,89,72,100,95,88};
	p1 = {67,89,72,100,95,88};
	...
	// ----- test 3 -----
	disabled = false;
	p0 = {1234,3483,234,5738,3421,5832,4433};
	p1 = {21,59,4,98,58,100,76};
