...
struct ReadingBooks {
	int countBooks(vector <string> p) {
		int c[3] = {}, d = 0;
		string s;
		ei(a, p) {
			int x = string("ise").find(a[0]);
			s += "ise"[x];
		}
		int sk = 0;
		ei(a, s) if (ai >= 2 && ai >= sk) {
			if (s[ai] != s[ai-1] && s[ai] != s[ai-2] && s[ai-1] != s[ai-2]) {
				sk = ai + 3;
				++d;
			}
		}
...
int main() {
	...
	// ----- test 0 -----
	disabled = false;
	p0 = {"introduction","story","introduction","edification"};
	p1 = 1;
	...
	// ----- test 1 -----
	disabled = false;
	p0 = {"introduction","story","edification","introduction","story","edification"};
	p1 = 2;
	...
	// ----- test 2 -----
	disabled = false;
	p0 = {"introduction","story","introduction","edification","story","introduction"};
	p1 = 1;
	...
	// ----- test 3 -----
	disabled = false;
	p0 = {"introduction","story","introduction","edification","story","story","edification","edification","edification","introduction","introduction","edification","story","introduction","story","edification","edification","story","introduction","edification","story","story","edification","introduction","story"};
	p1 = 5;
