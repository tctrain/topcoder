...
struct RestaurantManager {
	int allocateTables(vector <int> tb, vector <int> gs, vector <int> ar, vector <int> de) {
		vt(int, bool, int) m;
		ei(a, ar) m.eb(a, true, ai);
		ei(a, de) m.eb(a, false, ai);
		sr(m);
		sr(tb);
		int c = 0;
		vector<int> z(sz(tb), -1);
		ei(a, m) {
			if (g(a, 1)) {
				int s = gs[g(a, 2)];
				bool f = true;
...
int main() {
	...
	disabled = false;
	p0 = {10,8,11,16};
	p1 = {14,1,15,1,19,15,9,15,20,2};
	p2 = {4,5,7,18,21,25,29,31,46,49};
	p3 = {8,37,11,36,36,46,40,42,47,50};
	p4 = 69;
	...
	disabled = false;
	p0 = {18,15,2,6};
	p1 = {7,9,16,3,10,3,2,10,16,16};
	p2 = {10,15,19,20,21,22,27,35,37,43};
	p3 = {13,24,22,32,32,32,35,48,41,44};
	p4 = 10;
	...
	// ----- test 5 -----
	disabled = false;
	p0 = {13,9,6,1,9,8,6,2,8,20};
	p1 = {20,10,11,10,1,5,16,2,9,17};
	p2 = {12,14,64,78,100,121,151,155,162,164};
	p3 = {19,26,159,96,155,134,169,199,169,174};
	p4 = 17;
