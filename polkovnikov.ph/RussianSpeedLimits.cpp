...
bool KawigiEdit_RunTest(int testNum, vector <string> p0, bool hasAnswer, int p1) {
	...
	cout << "}";
	cout << "]" << endl;
	RussianSpeedLimits *obj;
	int answer;
	obj = new RussianSpeedLimits();
	clock_t startTime = clock();
	answer = obj->getCurrentLimit(p0);
