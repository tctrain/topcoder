...
struct FriendScore {
	int highestScore(vector <string> fr) {
		const int q = sz(fr);
		int mx = 0;
		fr(i, q) {
			vector<int> s;
			s.eb(i);
			fr(j, q) if (j != i) {
				if (fr[i][j] == 'N') continue;
				s.eb(j);
				fr(k, q) if (fr[j][k] == 'Y') s.eb(k);
			}
			uni(s);
			mx = max(mx, sz(s) - 1);
		}
...
int main() {
	...
	// ----- test 2 -----
	disabled = false;
	p0 = {"NYNNN","YNYNN","NYNYN","NNYNY","NNNYN"};
	p1 = 4;
	...
	// ----- test 3 -----
	disabled = false;
	p0 = {"NNNNYNNNNN","NNNNYNYYNN","NNNYYYNNNN","NNYNNNNNNN","YYYNNNNNNY","NNYNNNNNYN","NYNNNNNYNN","NYNNNNYNNN","NNNNNYNNNN","NNNNYNNNNN"};
	p1 = 8;
	...
	// ----- test 4 -----
	disabled = false;
	p0 = {"NNNNNNNNNNNNNNY","NNNNNNNNNNNNNNN","NNNNNNNYNNNNNNN","NNNNNNNYNNNNNNY","NNNNNNNNNNNNNNY","NNNNNNNNYNNNNNN","NNNNNNNNNNNNNNN","NNYYNNNNNNNNNNN","NNNNNYNNNNNYNNN","NNNNNNNNNNNNNNY","NNNNNNNNNNNNNNN","NNNNNNNNYNNNNNN","NNNNNNNNNNNNNNN","NNNNNNNNNNNNNNN","YNNYYNNNNYNNNNN"};
	p1 = 6;
